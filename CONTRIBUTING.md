# SpaceChop Contributor Guide

Excited about SpaceChop and want to make it better? We’re excited too!

SpaceChop is a community of developers just like you, striving to create the best tool for image processing. We welcome anyone who wants to contribute or provide constructive feedback, no matter the age or level of experience. If you want to help but don't know where to start, let us know, and we'll find something for you.
...
Most of the features in SpaceChop came from suggestions by you, the community! We welcome any ideas about how to make SpaceChop better for your use case. Head on over to the [SpaceChop Feature Request repo](https://github.com/spacechop/feature-requests), and open up a new feature request / discussion issue with your details.
...
1. **Open an issue.** Open an issue about your bug in this repo, or about your feature request in the [SpaceChop Feature Request repo](https://github.com/spacechop/feature-requests).
...
It’s important that every piece of code in SpaceChop is reviewed by at least one core contributor familiar with that codebase. Here are some things we look for:
